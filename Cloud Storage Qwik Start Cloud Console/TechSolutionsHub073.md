...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1760?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Cloud%20Storage%20Qwik%20Start%20Cloud%20Console/techsolutionshub073.sh
sudo chmod +x techsolutionshub073.sh
./techsolutionshub073.sh
```
</div>
