...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1234?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Network%20Tiers%20Optimizing%20Network%20Spend/techsolutionshub219.sh
sudo chmod +x techsolutionshub219.sh
./techsolutionshub219.sh
```
