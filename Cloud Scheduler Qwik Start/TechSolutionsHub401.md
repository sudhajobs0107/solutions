# ✨Cloud Scheduler: Qwik Start || GSP0401 ✨
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/3556?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Cloud%20Scheduler%20Qwik%20Start/techsolutionshub401.sh
sudo chmod +x techsolutionshub401.sh
./techsolutionshub401.sh
```
</div>
