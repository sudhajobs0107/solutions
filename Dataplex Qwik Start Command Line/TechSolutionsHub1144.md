...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/62708?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Dataplex%20Qwik%20Start%20Command%20Line/techsolutionshub1144.sh
sudo chmod +x techsolutionshub1144.sh
./techsolutionshub1144.sh
```
</div>
