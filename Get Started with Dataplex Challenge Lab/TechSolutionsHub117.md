# ✨Get Started with Dataplex: Challenge Lab || GSP117 ✨
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/62710?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Get%20Started%20with%20Dataplex%20Challenge%20Lab/techsolutionshub117.sh
sudo chmod +x techsolutionshub117.sh
./techsolutionshub117.sh
```
</div>
