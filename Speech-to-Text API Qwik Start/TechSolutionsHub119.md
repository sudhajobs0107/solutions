...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/588?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Speech-to-Text%20API%20Qwik%20Start/techsolutionshub119.sh
sudo chmod +x techsolutionshub119.sh
./techsolutionshub119.sh
```
</div>
