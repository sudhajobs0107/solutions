# ✨Perform Predictive Data Analysis in BigQuery: Challenge Lab || GSP347 ✨
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/37320?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Perform%20Predictive%20Data%20Analysis%20in%20BigQuery%20Challenge%20Lab/techsolutionshub374.sh
sudo chmod +x techsolutionshub347.sh
./techsolutionshub347.sh
```
</div>
