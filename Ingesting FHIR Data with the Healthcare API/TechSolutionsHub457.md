...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Ingesting%20FHIR%20Data%20with%20the%20Healthcare%20API/techsolutionshub457.sh
sudo chmod +x techsolutionshub457.sh
./techsolutionshub457.sh
```
