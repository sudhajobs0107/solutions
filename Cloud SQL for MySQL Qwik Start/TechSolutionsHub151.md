...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/936?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Cloud%20SQL%20for%20MySQL%20Qwik%20Start/techsolutionshub151.sh
sudo chmod +x techsolutionshub151.sh
./techsolutionshub151.sh
```
</div>
