...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/44159?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Cloud%20IAM%20Qwik%20Start/techsolutionshub064.sh
sudo chmod +x techsolutionshub064.sh
./techsolutionshub064.sh
```
</div>
