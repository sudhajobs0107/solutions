...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/42740?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Build%20Infrastructure%20with%20Terraform%20on%20Google%20Cloud%20Challenge%20Lab/techsolutionshub345.sh
sudo chmod +x techsolutionshub345.sh
./techsolutionshub345.sh
```
</div>
