...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/62711?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Create%20and%20Add%20Aspects%20to%20Dataplex%20Assets/techsolutionshub1145.sh
sudo chmod +x techsolutionshub1145.sh
./techsolutionshub1145.sh
```
</div>
