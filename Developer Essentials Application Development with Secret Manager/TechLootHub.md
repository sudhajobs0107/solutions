...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/127765?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```bash
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Developer%20Essentials%20Application%20Development%20with%20Secret%20Manager/techloothub.sh
sudo chmod +x techloothub.sh
./techloothub.sh
```
</div>
