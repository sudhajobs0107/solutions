...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/967?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Distributed%20Load%20Testing%20Using%20Kubernetes/techsolutionshub182.sh
sudo chmod +x techsolutionshub182.sh
./techsolutionshub182.sh
```
</div>
