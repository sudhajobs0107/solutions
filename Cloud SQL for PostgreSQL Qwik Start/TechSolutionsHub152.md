...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/937?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Cloud%20SQL%20for%20PostgreSQL%20Qwik%20Start/techsolutionshub152.sh
sudo chmod +x techsolutionshub152.sh
./techsolutionshub152.sh
```
</div>
