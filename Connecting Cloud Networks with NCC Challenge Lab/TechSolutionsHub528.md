...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/125010?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Connecting%20Cloud%20Networks%20with%20NCC%20Challenge%20Lab/techsolutionshub528.sh
sudo chmod +x techsolutionshub528.sh
./techsolutionshub528.sh
```
</div>
