...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/61486?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Store%20Process%20and%20Manage%20Data%20on%20Google%20Cloud%20Command%20Line%20Challenge%20Lab/techsolutionshub102.sh
sudo chmod +x techsolutionshub102.sh
./techsolutionshub102.sh
```
</div>
