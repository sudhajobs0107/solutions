...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/600?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Cloud%20Data%20Loss%20Prevention%20API%20Qwik%20Start/techsolutionshub107.sh
sudo chmod +x techsolutionshub107.sh
./techsolutionshub107.sh
```
</div>
