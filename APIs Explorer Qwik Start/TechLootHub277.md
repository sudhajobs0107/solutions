...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/APIs%20Explorer%20Qwik%20Start/techloothub277.sh
sudo chmod +x techloothub277.sh
./techloothub277.sh
```
</div>
