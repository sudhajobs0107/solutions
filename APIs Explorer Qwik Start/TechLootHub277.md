...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/2457?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/APIs%20Explorer%20Qwik%20Start/techsolutionshub277.sh
sudo chmod +x techsolutionshub277.sh
./techsolutionshub277.sh
```
</div>
