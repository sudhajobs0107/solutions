...
curl -O https://github.com/sudhajobs0107/solutions/blob/main/Introduction%20to%20SQL%20for%20BigQuery%20and%20Cloud%20SQL/start_station_name.csv

curl -O https://github.com/sudhajobs0107/solutions/blob/main/Introduction%20to%20SQL%20for%20BigQuery%20and%20Cloud%20SQL/end_station_name.csv

gsutil cp *start_station_name.csv gs://$PROJECT_ID/
gsutil cp *end_station_name.csv gs://$PROJECT_ID/
