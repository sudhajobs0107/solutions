...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/3618?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Explore%20an%20Ecommerce%20Dataset%20with%20SQL%20in%20BigQuery/techsolutionshub407.sh
sudo chmod +x techsolutionshub407.sh
./techsolutionshub407.sh
```
</div>
