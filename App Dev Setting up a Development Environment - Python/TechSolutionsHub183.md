...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1074?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/App%20Dev%20Setting%20up%20a%20Development%20Environment%20-%20Python/techsolutionshub183.sh
sudo chmod +x techsolutionshub183.sh
./techsolutionshub183.sh
```
</div>
