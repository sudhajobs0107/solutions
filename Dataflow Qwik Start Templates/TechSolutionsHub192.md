...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1101?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Dataflow%20Qwik%20Start%20Templates/techsolutionshub192.sh
sudo chmod +x techsolutionshub192.sh
./techsolutionshub192.sh
```
</div>
