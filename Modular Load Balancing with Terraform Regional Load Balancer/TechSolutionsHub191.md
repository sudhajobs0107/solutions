...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1207?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Modular%20Load%20Balancing%20with%20Terraform%20Regional%20Load%20Balancer/techsolutionshub191.sh
sudo chmod +x techsolutionshub191.sh
./techsolutionshub191.sh
```
</div>
