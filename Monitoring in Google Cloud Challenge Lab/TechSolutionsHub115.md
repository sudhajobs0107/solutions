...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/63855?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Monitoring%20in%20Google%20Cloud%20Challenge%20Lab/techsolutionshub115.sh
sudo chmod +x techsolutionshub115.sh
./techsolutionshub115.sh
```
</div>
