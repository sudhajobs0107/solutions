...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/12704?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Use%20Machine%20Learning%20APIs%20on%20Google%20Cloud%20Challenge%20Lab/techsolutionshub329.sh
sudo chmod +x techsolutionshub329.sh
./techsolutionshub329.sh
```
</div>
