...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/67855?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Custom%20Document%20Extraction%20with%20Document%20AI%20Workbench/techsolutionshub1142.sh
sudo chmod +x techsolutionshub1142.sh
./techsolutionshub1142.sh
```
</div>
