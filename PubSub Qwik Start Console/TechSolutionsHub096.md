...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/3719?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/PubSub%20Qwik%20Start%20Console/techsolutionshub096.sh
sudo chmod +x techsolutionshub096.sh
./techsolutionshub096.sh
```
</div>
