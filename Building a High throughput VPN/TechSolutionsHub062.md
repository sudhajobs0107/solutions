...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/641?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Building%20a%20High%20throughput%20VPN/techsolutionshub062.sh
sudo chmod +x techsolutionshub062.sh
./techsolutionshub062.sh
```
</div>
