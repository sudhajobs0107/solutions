...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/54357?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Create%20and%20Manage%20Cloud%20Spanner%20Instances%20Challenge%20Lab/techsolutionshub381.sh
sudo chmod +x techsolutionshub381.sh
./techsolutionshub381.sh
```
</div>
