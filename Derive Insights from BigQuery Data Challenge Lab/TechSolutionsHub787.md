...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/11988?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Derive%20Insights%20from%20BigQuery%20Data%20Challenge%20Lab/techsolutionshub787.sh
sudo chmod +x techsolutionshub787.sh
./techsolutionshub787.sh
```
</div>
