...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1145?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/BigQuery%20Qwik%20Start%20Console/techsolutionshub072.sh
sudo chmod +x techsolutionshub072.sh
./techsolutionshub072.sh
```
</div>
