...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/56622?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/SingleStore%20on%20Google%20Cloud/techsolutionshub1096.sh
sudo chmod +x techsolutionshub1096.sh
./techsolutionshub1096.sh
```
</div>
