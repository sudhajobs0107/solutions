...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/672?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Introduction%20to%20Cloud%20Dataproc%20Hadoop%20and%20Spark%20on%20Google%20Cloud/techsolutionshub123.sh
sudo chmod +x techsolutionshub123.sh
./techsolutionshub123.sh
```
</div>
