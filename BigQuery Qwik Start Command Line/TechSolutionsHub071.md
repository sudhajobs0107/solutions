...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/577?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/BigQuery%20Qwik%20Start%20Command%20Line/techsolutionshub071.sh
sudo chmod +x techsolutionshub071.sh
./techsolutionshub071.sh
```
</div>
