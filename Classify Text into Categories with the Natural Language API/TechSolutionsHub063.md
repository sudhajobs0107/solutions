...
<div align="center">
<a href="https://www.cloudskillsboost.google/focuses/1749?parent=catalog" target="_blank" rel="noopener noreferrer" style="text-decoration: none;">
...
```
curl -LO raw.githubusercontent.com/sudhajobs0107/solutions/refs/heads/main/Classify%20Text%20into%20Categories%20with%20the%20Natural%20Language%20API/techsolutionshub063.sh
sudo chmod +x techsolutionshub063.sh
./techsolutionshub063.sh
```
</div>
